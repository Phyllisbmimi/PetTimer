...
export default function LoginPage({ onSwitchToSignup, onGuestMode }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center p-4 relative">
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8">
        ...
        <button
          onClick={onGuestMode}
          className="w-full text-center mt-4 text-gray-600 hover:text-gray-800 font-medium text-sm"
        >
          {t('auth.visitorMode')}
        </button>
